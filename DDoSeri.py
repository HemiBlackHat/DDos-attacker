...
print (f"\t [*]Creator:{Fore.YELLOW} Hamid")
foni = f"""{Fore.RED}
#################################
#                               #      {Fore.RED}<<<ddoser hamid>>>
#                               #
#‌        {Fore.YELLOW}Hemi Black Hat{Fore.RED}         #     
#                               # 
#                               #
#################################\n\n"""
...
print (Back.RED+Fore.WHITE+"[*]GitHub: https://github.com/HemiBlackHat\n[*]TelegramID: @Lockeder_weblog\n[*]RubikaID: @krearur\033[0m\n")
